    ...
    <section class="content">
      ...
      <div class="col-md-6">
       <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="updateorder.php">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Name</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="i1" value="<?php echo $name; ?>" readonly>
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="i2" value="<?php echo $id; ?>">
                  </div>
                </div>
               <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Delivered</label>

                  <div class="col-sm-10">
        			<label class="switch">
					<?php if($row['status']==1) { ?>
					<input type="checkbox" value="yes" name="delivered" checked> <?php } 
					else
					{ ?>
						<input type="checkbox" value="yes" name="delivered" >
					<?php } ?>
