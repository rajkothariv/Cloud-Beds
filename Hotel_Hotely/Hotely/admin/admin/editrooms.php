    ...
    <section class="content">
      ...
      <div class="col-md-6">
       <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="updateroom.php">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Name</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="i1" value="<?php echo $row['roomname']; ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Accom.</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="i2" value="<?php echo $row['accomodation']; ?>">
                  </div>
                </div>
