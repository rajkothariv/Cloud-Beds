...
$(document).ready(function()
{
  $("tr:first").css("background-color", "#CCE5FF");
});
</script>
	<meta charset="utf-8">
...
<div id="Filters" style="margin-left:470px;">
           
            <select   class="form-group col-md-6 col-sm-6 col-xs-12" name="filter" onchange="filter(this.value)">
